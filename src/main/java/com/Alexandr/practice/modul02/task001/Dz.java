...
public class Dz {
    public static void main(String[] args) {
        ...
        DZ.max(Array);
        DZ.max(Array1);
        DZ.maxPositive(Array);
        DZ.maxPositive(Array1);
        DZ.multiplication(Array);
        DZ.multiplication(Array1);
        DZ.modulus(Array);
        DZ.modulus(Array1);
        DZ.secondLargest(Array);
        DZ.secondLargest(Array1);
    ...
    public void maxPositive(int Array[]) {
        ...
        System.out.println("Максимальное позитивное число: " + a);
    }
